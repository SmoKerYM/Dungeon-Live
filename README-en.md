...
- **HP bar** — A flat capsule health bar sits centred at the top of the screen, bound to the currently loaded character sheet (players auto-load their own on join; the DM's follows whichever sheet they open). Green above 50%, amber 25–50%, red below 25%. Click the bar to edit current/max HP inline; players also get ± buttons for 1 point of healing or damage (max HP still requires clicking the bar). Changes broadcast live to the player list and token tooltips
