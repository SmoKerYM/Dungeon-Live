...
/** 远程武器词 → ranged（用敏捷） */
const ATTACK_RANGED_CN = ['远程', '开枪', '射击', '开火', '手枪', '步枪', '霰弹枪', '枪', '弓', '弩'];
const ATTACK_RANGED_EN = ['ranged', 'shoot'];
/** 力量近战武器词 → melee（用力量）。注意「近战」两个字本身不在这里：
 *  只说「近战」而没说武器时按没提武器处理，走 finesse 取高 */
const ATTACK_MELEE_CN = ['棍', '棒', '斧', '锤', '撬棍', '铁管', '拳', '徒手'];
const ATTACK_MELEE_EN = ['club', 'bat', 'axe', 'hammer'];
/** 灵巧武器词 → finesse（取力量/敏捷较高的） */
const ATTACK_FINESSE_CN = ['匕首', '小刀', '剔骨刀', '短剑', '细剑', '飞刀', '刀'];
const ATTACK_FINESSE_EN = ['dagger', 'knife', 'rapier'];
...
module.exports = {
  ...
  ATTACK_RANGED_CN, ATTACK_RANGED_EN, ATTACK_MELEE_CN, ATTACK_MELEE_EN,
  ATTACK_FINESSE_CN, ATTACK_FINESSE_EN, DAMAGE_CN, DAMAGE_EN,
