 ...
 *       skill → 对应属性 + (熟练技能 ? PB : 0)；initiative → 敏捷；deathSave → 0。
 ...
 */
function buildRollLabel(intent) {
  let core = '';
  switch (intent.type) {
 ...
 */
function buildRollOutcome(player, intent, modifier) {
...
module.exports = { computeRollModifier, buildRollLabel, buildRollExpr, rollD20, buildRollOutcome };
